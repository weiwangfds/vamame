...
pub(crate) fn draw_cursor_lines(
    ...
    match mode {
        CursorMode::Vertical => {
            ...
            plot_ui.line(
                Line::new(PlotPoints::from(vec![[pos_a, y_min], [pos_a, y_max]]))
                    .color(color_a)
                    .width(1.5),
            );
            plot_ui.line(
                Line::new(PlotPoints::from(vec![[pos_b, y_min], [pos_b, y_max]]))
                    .color(color_b)
                    .width(1.5),
            );
        }
        CursorMode::Horizontal => {
            ...
            plot_ui.line(
                Line::new(PlotPoints::from(vec![[x_min, pos_a], [x_max, pos_a]]))
                    .color(color_a)
                    .width(1.5),
            );
            plot_ui.line(
                Line::new(PlotPoints::from(vec![[x_min, pos_b], [x_max, pos_b]]))
                    .color(color_b)
                    .width(1.5),
            );
        }
